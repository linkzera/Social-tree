    ...
    <div className="bg-bgWhite min-h-screen">
      <main className="w-full flex flex-col justify-center">
        ...
        <div className="flex flex-col items-center justify-center pb-10 pt-[100px] gap-5">
          ...
          />
          <a href="https://www.instagram.com/" target="_blank" className="old">
            <span
        ...
        <div className="px-11 md:px-64 lg:px-[30%] 2xl:px-[40%] flex flex-col gap-4 w-full justify-center ">
          <Button text="Link 1" link="https://www.instagram.com/" />
          <Button text="Link 2" link="https://www.instagram.com/" />
          <Button text="Link 3" link="https://www.instagram.com/" />
          <Button text="Link 4" link="https://www.instagram.com/" />
        </div>
